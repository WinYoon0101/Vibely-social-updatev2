...
const CreateGroupPost = ({
  ...
  const { createGroupPost, fetchPosts } = usePostStore();
    ...
    <>
      <Dialog open={isPostFormOpen} onOpenChange={setIsPostFormOpen}>
        ...
        <DialogContent className="sm:max-w-[550px] bg-white rounded-lg">
          ...
          <Textarea
            placeholder={`Bạn muốn chia sẻ điều gì hôm nay với nhóm ${groupName}?`}
          ...
          <div className="flex justify-between mt-4">
            ...
            <Popover.Root>
              ...
              <Popover.Portal>
                <Popover.Content
                  className="bg-white shadow-lg rounded-md p-2 w-64 z-50"
                  side="top"
                  align="center"
                >
