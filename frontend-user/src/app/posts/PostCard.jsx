...
const PostCard = ({ post, onReact, onComment, onShare, onDelete, onEdit }) => {
  ...
  useEffect(() => {
    setReaction(
      post?.reactions?.find((react) => react?.user?._id == user?._id)
        ? post?.reactions?.find((react) => react?.user?._id == user?._id).type
        : null
    );
      ...
      <Card className="bg-white shadow-md rounded-lg border border-gray-200">
        <CardContent className="p-4">
          <div className="flex items-center justify-between mb-4 relative">
            ...
            <Button
              ...
              className={`hover:bg-gray-100 ${
                post?.user?._id === user?._id ? "flex" : "hidden"
              }`} //chủ bài viết mới có option này
            >
            ...
            {dropdownOpen && (
              <div
                className="absolute top-10 right-4 w-40 bg-white border border-gray-300 rounded-md shadow-lg"
                ref={dropdownRef}
              >
          ...
          {editPost && (
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-80 z-50">
              <div className="flex flex-col justify-center bg-white p-6 rounded-lg shadow-lg w-1/3">
                <p className="text-lg font-bold mb-4 self-center">
                  Sửa bài viết
                </p>
                <Textarea
            ...
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-80 z-50">
              <div className="bg-white p-6 rounded-lg shadow-lg" ref={popupRef}>
                ...
                <p className="text-md mb-4">
                  Hành động này không thể hoàn tác và toàn bộ nội dung của bài
                  viết sẽ bị xóa bỏ.
                </p>
              ...
              <div className="bg-white p-6 h-96 rounded-lg shadow-lg flex flex-col">
                <div className="flex items-center justify-between gap-20 md:gap-40 pb-5">
                  <div className="flex md:gap-10 h-10 justify-center items-center">
                    <motion.button
                      whileHover={{ scale: 1.2 }} //phóng to biểu tượng lên
                      className={`px-2 py-2 ${
                        currentReactionDetail === "like"
                          ? "border-b-2 border-[#086280]"
                          : ""
                      } `}
                      onClick={() => {
                ...
                {reactionUserGroups?.[currentReactionDetail]?.map(
                  (user, index) => {
                    return (
                      <div
                        key={index}
          ...
          <div className="flex justify-between items-center mb-2">
            <span
              className="text-[15px] text-gray-500 hover:underline border-gray-400 cursor-pointer flex"
              onClick={() => {
              ...
              >
                {totalComment > 0 &&
                  (totalComment > 1000000
                    ? totalComment / 1000000 + " triệu" //Nếu tổng lượt react >1tr thì hiển thị kiểu 1 triệu, 2 triệu,...
                    : totalComment > 1000
                    ? totalComment / 1000 + " ngàn"
                    : totalComment + //Nếu tổng lượt react >1000 thì hiển thị kiểu 1 ngàn, 2 ngàn,...
                      " bình luận")}
              </span>
          ...
          <div className="flex justify-between mb-1 relative">
            ...
            >
              {reaction == "like" ? (
                <Image src={"/like.png"} alt="haha" width={24} height={24} />
              ) : reaction == "love" ? (
                <Image src={"/love.png"} alt="haha" width={24} height={24} />
              ) : reaction == "haha" ? (
                <Image src={"/haha.png"} alt="haha" width={24} height={24} />
              ) : reaction == "wow" ? (
                <Image src={"/wow.png"} alt="haha" width={24} height={24} />
              ) : reaction == "sad" ? (
                <Image src={"/sad.png"} alt="haha" width={24} height={24} />
              ) : reaction == "angry" ? (
                <Image src={"/angry.png"} alt="haha" width={24} height={24} />
              ) : (
