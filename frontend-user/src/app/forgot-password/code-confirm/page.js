  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#F9FDFF] p-6">
      <form
        ...
        className="w-[34%] bg-white shadow-md rounded-lg p-8 text-center border border-[#0E42D2]"
      >
        <div className="mb-6 flex justify-center">
          <Image
            src="/images/vibely_full_logo.png"
            alt="Vibely Logo"
            width={80}
            height={30}
          />
        ...
        <p className="text-sm mb-4 text-left text-[#C6C6C8]">
          <strong>
            Vui lòng kiểm tra email và nhập mã xác nhận để hoàn thành quá trình
        ...
        <div className="flex justify-end text-gray-500 text-sm">
          <Link
            ...
            className="hover:underline mr-2 text-[#B0C4DE]"
          >
            Quay trở lại
          </Link>
          <Link href="/user-login" className="font-bold text-[#086280]">
            Đăng nhập
          </Link>
        </div>
      </form>
